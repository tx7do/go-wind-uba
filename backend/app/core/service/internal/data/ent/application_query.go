...
func (_q *ApplicationQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ApplicationQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *ApplicationQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ApplicationQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *ApplicationQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *ApplicationQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ApplicationQuery) ForUpdate(opts ...sql.LockOption) *ApplicationQuery {
...
func (_q *ApplicationQuery) ForShare(opts ...sql.LockOption) *ApplicationQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *ApplicationQuery) Modify(modifiers ...func(s *sql.Selector)) *ApplicationSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ApplicationSelect) Modify(modifiers ...func(s *sql.Selector)) *ApplicationSelect {
