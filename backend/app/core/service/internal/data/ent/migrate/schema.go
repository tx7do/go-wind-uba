...
var (
	...
	UbaApplicationsColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeString, Nullable: true, Comment: "应用类型"},
		{Name: "status", Type: field.TypeEnum, Nullable: true, Comment: "应用状态", Enums: []string{"ON", "OFF"}, Default: "ON"},
		{Name: "platforms", Type: field.TypeJSON, Nullable: true, Comment: "应用支持的平台列表"},
	...
	// UbaEventSchemasColumns holds the columns for the "uba_event_schemas" table.
	UbaEventSchemasColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint32, Increment: true, Comment: "id"},
		{Name: "created_at", Type: field.TypeTime, Nullable: true, Comment: "创建时间"},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true, Comment: "更新时间"},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, Comment: "删除时间"},
		...
		{Name: "deleted_by", Type: field.TypeUint32, Nullable: true, Comment: "删除者ID"},
		{Name: "tenant_id", Type: field.TypeUint32, Nullable: true, Comment: "租户ID", Default: 0},
		{Name: "event_name", Type: field.TypeString, Nullable: true, Comment: "事件名，唯一业务标识，对应 events_fact.event_name"},
		{Name: "display_name", Type: field.TypeString, Nullable: true, Comment: "显示名"},
		{Name: "category", Type: field.TypeString, Nullable: true, Comment: "事件类别"},
		{Name: "description", Type: field.TypeString, Nullable: true, Comment: "事件描述"},
		{Name: "properties", Type: field.TypeJSON, Nullable: true, Comment: "属性 schema 列表"},
		{Name: "status", Type: field.TypeString, Nullable: true, Comment: "启用状态：ENABLED/DISABLED", Default: "ENABLED"},
	}
	// UbaEventSchemasTable holds the schema information for the "uba_event_schemas" table.
	UbaEventSchemasTable = &schema.Table{
		Name:       "uba_event_schemas",
		Comment:    "UBA事件Schema定义表",
		Columns:    UbaEventSchemasColumns,
		PrimaryKey: []*schema.Column{UbaEventSchemasColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "uix_uba_event_schemas_tenant_event_name",
				Unique:  true,
				Columns: []*schema.Column{UbaEventSchemasColumns[7], UbaEventSchemasColumns[8]},
			},
			{
				Name:    "idx_uba_event_schemas_tenant_id",
				Unique:  false,
				Columns: []*schema.Column{UbaEventSchemasColumns[7]},
			},
			{
				Name:    "idx_uba_event_schemas_category",
				Unique:  false,
				Columns: []*schema.Column{UbaEventSchemasColumns[10]},
			},
			{
				Name:    "idx_uba_event_schemas_status",
				Unique:  false,
				Columns: []*schema.Column{UbaEventSchemasColumns[13]},
			},
			{
				Name:    "idx_uba_event_schemas_created_at",
				Unique:  false,
				Columns: []*schema.Column{UbaEventSchemasColumns[1]},
			},
		},
	}
	...
	UbaRiskRulesColumns = []*schema.Column{
		...
		{Name: "risk_type", Type: field.TypeString, Nullable: true, Comment: "风险类型，规则对应的风险类型"},
		{Name: "default_level", Type: field.TypeString, Nullable: true, Comment: "默认风险等级，规则对应的默认风险等级"},
	...
	UbaTagDefinitionsColumns = []*schema.Column{
		...
		{Name: "category", Type: field.TypeString, Nullable: true, Comment: "标签分类，如用户属性、行为偏好、风险、业务等"},
		{Name: "tag_type", Type: field.TypeString, Nullable: true, Comment: "标签类型，如布尔、枚举、数值、字符串、列表等"},
	...
	UbaUserTagsColumns = []*schema.Column{
		...
		{Name: "source", Type: field.TypeString, Nullable: true, Comment: "标签来源"},
...
func init() {
	...
	UbaEventSchemasTable.Annotation = &entsql.Annotation{
