...
const (
	ReportService_PostReport_FullMethodName = "/uba.service.v1.ReportService/PostReport"
)
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "uba.service.v1.ReportService",
	...
	Metadata: "uba/service/v1/report.proto",
}
