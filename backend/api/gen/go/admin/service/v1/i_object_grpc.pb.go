...
const (
	ObjectService_List_FullMethodName   = "/admin.service.v1.ObjectService/List"
	ObjectService_Get_FullMethodName    = "/admin.service.v1.ObjectService/Get"
	ObjectService_Create_FullMethodName = "/admin.service.v1.ObjectService/Create"
)
...
type ObjectServiceClient interface {
	// 查询对象维度列表
	List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListObjectDimResponse, error)
	// 查询对象维度详情
...
func (c *objectServiceClient) List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListObjectDimResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ListObjectDimResponse)
...
func (c *objectServiceClient) Get(ctx context.Context, in *v11.GetObjectDimRequest, opts ...grpc.CallOption) (*v11.ObjectDim, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedObjectServiceServer) List(context.Context, *v1.PagingRequest) (*v11.ListObjectDimResponse, error) {
...
func _ObjectService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.GetObjectDimRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ObjectServiceServer).Get(ctx, req.(*v11.GetObjectDimRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ObjectService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.CreateObjectDimRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ObjectServiceServer).Create(ctx, req.(*v11.CreateObjectDimRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ObjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.service.v1.ObjectService",
	...
	Metadata: "admin/service/v1/i_object.proto",
}
