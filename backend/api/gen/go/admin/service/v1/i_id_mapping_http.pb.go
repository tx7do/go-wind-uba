...
func RegisterIDMappingServiceHTTPServer(s *http.Server, srv IDMappingServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/id-mappings", _IDMappingService_List10_HTTP_Handler(srv))
	r.GET("/admin/v1/id-mappings/{id}", _IDMappingService_Get10_HTTP_Handler(srv))
}

func _IDMappingService_List10_HTTP_Handler(srv IDMappingServiceHTTPServer) func(ctx http.Context) error {
...
func _IDMappingService_Get10_HTTP_Handler(srv IDMappingServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
