...
var File_admin_service_v1_i_object_proto protoreflect.FileDescriptor
...
var file_admin_service_v1_i_object_proto_goTypes = []any{
	...
	(*v11.GetObjectDimRequest)(nil),    // 1: uba.service.v1.GetObjectDimRequest
...
var file_admin_service_v1_i_object_proto_depIdxs = []int32{
	...
	1, // 1: admin.service.v1.ObjectService.Get:input_type -> uba.service.v1.GetObjectDimRequest
...
func init() { file_admin_service_v1_i_object_proto_init() }
func file_admin_service_v1_i_object_proto_init() {
	if File_admin_service_v1_i_object_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_object_proto_rawDesc), len(file_admin_service_v1_i_object_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_service_v1_i_object_proto_goTypes,
		DependencyIndexes: file_admin_service_v1_i_object_proto_depIdxs,
	}.Build()
	File_admin_service_v1_i_object_proto = out.File
	file_admin_service_v1_i_object_proto_goTypes = nil
	file_admin_service_v1_i_object_proto_depIdxs = nil
}
