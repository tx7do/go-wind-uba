...
import { loginPolicyMethodList, loginPolicyTypeList, useCreateLoginPolicy, useUpdateLoginPolicy } from '#/api';
const data = ref();
  ...
  async onConfirm() {
    ...
    try {
      await (data.value?.create
        ...
        : updateLoginPolicy({ id: data.value.row.id, values: values }));
