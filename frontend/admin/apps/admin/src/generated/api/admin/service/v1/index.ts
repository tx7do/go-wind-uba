...
export interface ApiService {
  ...
  // 查询API资源详情
  Get(
    request: resourceservicev1_GetApiRequest,
  ): Promise<resourceservicev1_Api>;
  // 创建API资源
  Create(
    request: resourceservicev1_CreateApiRequest,
  ): Promise<wellKnownEmpty>;
  // 更新API资源
  Update(
    request: resourceservicev1_UpdateApiRequest,
  ): Promise<wellKnownEmpty>;
  // 删除API资源
  Delete(
    request: resourceservicev1_DeleteApiRequest,
  ): Promise<wellKnownEmpty>;
  // 同步API资源
  SyncApis(
    request: wellKnownEmpty,
...
export interface ApplicationService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListApplicationResponse>;
  // 获取应用数据
  Get(
    request: ubaservicev1_GetApplicationRequest,
  ): Promise<ubaservicev1_Application>;
  // 创建应用
  Create(
    request: ubaservicev1_CreateApplicationRequest,
  ): Promise<ubaservicev1_Application>;
  // 更新应用
  Update(
    request: ubaservicev1_UpdateApplicationRequest,
  ): Promise<ubaservicev1_Application>;
  // 删除应用
  Delete(
    request: ubaservicev1_DeleteApplicationRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createApplicationServiceClient(
  ...
  return {
    ...
    Get(request) {
      ...
      const path = `admin/v1/apps/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.appId) {
        queryParams.push(
          `appId=${encodeURIComponent(request.appId.toString())}`,
        );
      }
      if (request.viewMask) {
        queryParams.push(
...
export interface EventPathService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListEventPathResponse>;
  // 查询单条事件路径详情
  Get(
    request: ubaservicev1_GetEventPathRequest,
  ): Promise<ubaservicev1_EventPath>;
}
...
export function createEventPathServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/event-paths`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      if (request.pathId === undefined || request.pathId === null) {
        throw new Error('missing required field request.path_id');
      }
      const path = `admin/v1/event-paths/${request.pathId}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export type ubaservicev1_EventPath = {
  // 转化事件名称（目标转化对应的事件名称）
  conversionEvent: string | undefined;
  conversionTime: undefined | wellKnownTimestamp;
  // 路径结束时间（最后一个节点事件时间）
  endTime: undefined | wellKnownTimestamp;
  eventDate: undefined | wellKnownTimestamp;
  ...
  // 路径指标
  // 路径起始时间（第一个节点事件时间）
  startTime: undefined | wellKnownTimestamp;
  // 步骤数（路径节点总数）
...
export interface IDMappingService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListIDMappingResponse>;
  // 查询ID映射详情
  Get(
    request: ubaservicev1_GetIDMappingRequest,
  ): Promise<ubaservicev1_IDMapping>;
}
...
export function createIDMappingServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/id-mappings`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/id-mappings/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export interface MenuService {
  ...
  // 创建菜单
  Create(
    request: resourceservicev1_CreateMenuRequest,
  ): Promise<wellKnownEmpty>;
  // 更新菜单
  Update(
    request: resourceservicev1_UpdateMenuRequest,
  ): Promise<wellKnownEmpty>;
  // 删除菜单
  Delete(
    request: resourceservicev1_DeleteMenuRequest,
  ): Promise<wellKnownEmpty>;
}
...
export interface ObjectService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListObjectDimResponse>;
  // 查询对象维度详情
  Get(
    request: ubaservicev1_GetObjectDimRequest,
  ): Promise<ubaservicev1_ObjectDim>;
  // 创建对象维度
  Create(
    request: ubaservicev1_CreateObjectDimRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createObjectServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/object-dims`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/object-dims/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export type ubaservicev1_ObjectDim = {
  ...
  updatedBy?: number;
  // 有效期起始时间（对象有效期的开始时间）
  validFrom: undefined | wellKnownTimestamp;
  // 有效期结束时间（对象有效期的结束时间）
  validTo: undefined | wellKnownTimestamp;
};
...
export interface RiskEventService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListRiskEventResponse>;
  // 查询风险事件数量
  Count(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_CountRiskEventResponse>;
  // 查询风险事件详情
  Get(
    request: ubaservicev1_GetRiskEventRequest,
  ): Promise<ubaservicev1_RiskEvent>;
  // 创建风险事件
  Create(
    request: ubaservicev1_CreateRiskEventRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createRiskEventServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/risk-events`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Count(request) {
      const path = `admin/v1/risk-events/count`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/risk-events/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export interface RiskRuleService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListRiskRuleResponse>;
  // 查询风险规则数量，返回总数
  Count(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_CountRiskRuleResponse>;
  // 查询风险规则详情，根据ID获取单条规则
  Get(
    request: ubaservicev1_GetRiskRuleRequest,
  ): Promise<ubaservicev1_RiskRule>;
  // 创建风险规则，返回新建的规则对象
  Create(
    request: ubaservicev1_CreateRiskRuleRequest,
  ): Promise<ubaservicev1_RiskRule>;
  // 更新风险规则，根据ID和字段掩码更新规则
  Update(
    request: ubaservicev1_UpdateRiskRuleRequest,
  ): Promise<ubaservicev1_RiskRule>;
  // 删除风险规则，根据ID删除规则
  Delete(
    request: ubaservicev1_DeleteRiskRuleRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createRiskRuleServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/risk-rules`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Count(request) {
      const path = `admin/v1/risk-rules/count`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/risk-rules/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export interface SessionService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListSessionResponse>;
  // 查询单条会话详情
  Get(
    request: ubaservicev1_GetSessionRequest,
  ): Promise<ubaservicev1_Session>;
}
...
export function createSessionServiceClient(
  ...
  return {
    ...
    Get(request) {
      ...
      const path = `admin/v1/sessions/${request.id}`;
      const body = null;
      return transport.unary(path, 'GET', body, {
        service: 'SessionService',
        method: 'Get',
...
export interface TagDefinitionService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListTagDefinitionResponse>;
  // 查询标签定义数量
  Count(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_CountTagDefinitionResponse>;
  // 查询标签定义详情
  Get(
    request: ubaservicev1_GetTagDefinitionRequest,
  ): Promise<ubaservicev1_TagDefinition>;
  // 创建标签定义
  Create(
    request: ubaservicev1_CreateTagDefinitionRequest,
  ): Promise<ubaservicev1_TagDefinition>;
  // 更新标签定义
  Update(
    request: ubaservicev1_UpdateTagDefinitionRequest,
  ): Promise<ubaservicev1_TagDefinition>;
  // 删除标签定义
  Delete(
    request: ubaservicev1_DeleteTagDefinitionRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createTagDefinitionServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/tag-definitions`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Count(request) {
      const path = `admin/v1/tag-definitions/count`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/tag-definitions/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export interface UserBehaviorProfileService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListUserBehaviorProfileResponse>;
  // 查询用户画像详情
  Get(
    request: ubaservicev1_GetUserBehaviorProfileRequest,
  ): Promise<ubaservicev1_UserBehaviorProfile>;
}
...
export function createUserBehaviorProfileServiceClient(
  ...
  return {
    List(request) {
      const path = `admin/v1/user-behavior-profiles`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/user-behavior-profiles/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export type ubaservicev1_UserBehaviorProfile = {
  ...
  // 设备类型
  deviceType?: string;
  firstActiveDate: undefined | wellKnownTimestamp;
  // 地理位置
  geo: { [key: string]: string } | undefined;
  // 自增长主键ID
  id?: number;
  lastActiveDate: undefined | wellKnownTimestamp;
  lastPayTime: undefined | wellKnownTimestamp;
  // 最后风险时间
  ...
  // 基础属性
  registerTime: undefined | wellKnownTimestamp;
  // 风险等级
  riskLevel?: string;
  // 风险画像
...
export interface UserTagService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListUserTagResponse>;
  // 查询用户标签数量
  Count(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_CountUserTagResponse>;
  // 查询用户标签详情
  Get(
    request: ubaservicev1_GetUserTagRequest,
  ): Promise<ubaservicev1_UserTag>;
  // 创建用户标签
  Create(
    request: ubaservicev1_CreateUserTagRequest,
  ): Promise<ubaservicev1_UserTag>;
  // 更新用户标签
  Update(
    request: ubaservicev1_UpdateUserTagRequest,
  ): Promise<ubaservicev1_UserTag>;
  // 删除用户标签
  Delete(
    request: ubaservicev1_DeleteUserTagRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createUserTagServiceClient(
  ...
  return {
    ...
    Count(request) {
      const path = `admin/v1/user-tags/count`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/user-tags/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export interface WebhookService {
  ...
  List(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_ListWebhookResponse>;
  // 查询网络钩子数量
  Count(
    request: pagination_PagingRequest,
  ): Promise<ubaservicev1_CountWebhookResponse>;
  // 查询网络钩子详情
  Get(
    request: ubaservicev1_GetWebhookRequest,
  ): Promise<ubaservicev1_Webhook>;
  // 创建网络钩子
  Create(
    request: ubaservicev1_CreateWebhookRequest,
  ): Promise<ubaservicev1_Webhook>;
  // 更新网络钩子
  Update(
    request: ubaservicev1_UpdateWebhookRequest,
  ): Promise<ubaservicev1_Webhook>;
  // 删除网络钩子
  Delete(
    request: ubaservicev1_DeleteWebhookRequest,
  ): Promise<wellKnownEmpty>;
}
...
export function createWebhookServiceClient(
  ...
  return {
    ...
    Count(request) {
      const path = `admin/v1/webhooks/count`;
      const body = null;
      const queryParams: string[] = [];
      if (request.page) {
        queryParams.push(
    ...
    Get(request) {
      ...
      const path = `admin/v1/webhooks/${request.id}`;
      const body = null;
      const queryParams: string[] = [];
      if (request.viewMask) {
        queryParams.push(
...
export class ApiClient {
  ...
  private _riskEventService?: RiskEventService;
  private _riskRuleService?: RiskRuleService;
  private _roleService?: RoleService;
  private _sessionService?: SessionService;
  private _tagDefinitionService?: TagDefinitionService;
  private _taskService?: TaskService;
  private _tenantService?: TenantService;
  private readonly _transport: ClientTransport;
  private _userBehaviorProfileService?: UserBehaviorProfileService;
  private _userProfileService?: UserProfileService;
  private _userService?: UserService;
  private _userTagService?: UserTagService;
  ...
  get applicationService(): ApplicationService {
    return this._applicationService ??= createApplicationServiceClient(this._transport);
  }
  ...
  get iDMappingService(): IDMappingService {
    return this._iDMappingService ??= createIDMappingServiceClient(this._transport);
  }
  ...
  get objectService(): ObjectService {
    return this._objectService ??= createObjectServiceClient(this._transport);
  }
  ...
  get riskEventService(): RiskEventService {
    return this._riskEventService ??= createRiskEventServiceClient(this._transport);
  }

  get riskRuleService(): RiskRuleService {
    return this._riskRuleService ??= createRiskRuleServiceClient(this._transport);
  }
  ...
  get tagDefinitionService(): TagDefinitionService {
    return this._tagDefinitionService ??= createTagDefinitionServiceClient(this._transport);
  }
  ...
  get userBehaviorProfileService(): UserBehaviorProfileService {
    return this._userBehaviorProfileService ??= createUserBehaviorProfileServiceClient(this._transport);
  }
  ...
  get userTagService(): UserTagService {
    return this._userTagService ??= createUserTagServiceClient(this._transport);
  }

  get webhookService(): WebhookService {
    return this._webhookService ??= createWebhookServiceClient(this._transport);
  }
}
